...
\def\SoftmaxColores{rgb:magenta,5;black,3} 
"""
...
# Conv
def to_Conv( name, s_filer=256, n_filer=64, offset="(0,0,0)", to="(0,0,0)", width=1, height=40, depth=40, caption=" ", color="magenta,5" ):
    return r"""
